## Function file
# Network variants for the case study
...
drn_pp <- function(train, X, i_valid = NULL, loc_id_vec = NULL,
  ...
  ###Output
  #res...List containing:
  #......f...............Distributional forecasts (i.e. parameters) based on nn_train (n x n_q matrix)
